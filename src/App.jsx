...
import { Plus, Trash2, Copy, Check, Settings, Sparkles, MessageSquare, Bold, Italic, Underline, Strikethrough, Quote, Code, ChevronUp, ChevronDown, Undo2, Redo2, Save, ImageDown, Smile, FileCode2, Maximize, Minimize, Download, Upload, ScrollText, Languages, List, Heading, AtSign, Clock, Hash, RotateCcw, Image as ImageIcon, Link as LinkIcon, User as UserIcon, X, FolderOpen, ZoomIn, ZoomOut } from 'lucide-react';
  ...
  return (
    <div className={`app-container ${isZenMode ? 'zen-mode' : ''}`} style={{ '--embed-color': state.embedColor }}>
      ...
      <div className="editor-section">
        ...
        <h1 style={{ marginTop: '1rem', marginBottom: '0.5rem' }}>Update Maker <Sparkles size={32} style={{ display: 'inline', color: 'var(--accent)' }} /></h1>
